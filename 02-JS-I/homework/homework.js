...
function obtenerAreaRectangulo(alto, ancho) {
    // 28-Retornar el area de un rectángulo teniendo su altura y ancho
    // Tu código:
    return alto * ancho;
}

function retornarPerimetro(lado) {
    //29-Escibe una función a la cual reciba el valor del lado de un cuadrado y retorne su perímetro.
    //Escribe tu código aquí
    return lado * 4;
}

function areaDelTriangulo(base, altura) {
    //30-Desarrolle una función que calcule el área de un triángulo.
    //Escribe tu código aquí
...
function esVocal(letra) {
    //31-Escribe una función que reciba una letra y, si es una vocal, muestre el mensaje “Es vocal”.
